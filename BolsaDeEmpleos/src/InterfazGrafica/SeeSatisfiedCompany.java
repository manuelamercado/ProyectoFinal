...
fila = new Object[5];
for (int i = 0; i <Satisfied.getInstanceSatisfied().getCompanySatisfied().getCompanies().size(); i++)
{
fila[0] = i+1;
fila[1] = Satisfied.getInstanceSatisfied().getCompanySatisfied().getCompanies().get(i).getRNC();
fila[2] = Satisfied.getInstanceSatisfied().getCompanySatisfied().getCompanies().get(i).getName();
fila[3] = Satisfied.getInstanceSatisfied().getCompanySatisfied().getCompanies().get(i).getArea();
fila[4] = Satisfied.getInstanceSatisfied().getCompanySatisfied().getCompanies().get(i).getPhone();
