...
public class Welcome extends JFrame {
	...
	public Welcome() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				Welcome.class
						.getResource("/InterfazGrafica/Encontrar-Trabajo.jpg")));
		...
		mnInicio.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/1416514885_home.png")));
		...
		mnRegistrar.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/Modify.png")));
		...
		menuItemSolicitante.setIcon(new ImageIcon(Welcome.class
		...
		mntmEmpresa.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/1416396195_Company.png")));
		mnRegistrar.add(mntmEmpresa);

		JMenu mnBaseDeDatos = new JMenu("BASE DE DATOS");
		menuBar.add(mnBaseDeDatos);
		mnBaseDeDatos.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/1416395841_archive.png")));
		mnBaseDeDatos.setFont(new Font("Tahoma", Font.BOLD, 12));

		JMenu mnSolicitudes = new JMenu("Solicitudes");
		mnSolicitudes.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/Info.png")));
		...
		mntmEmpleados.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/1416396281_testimonials.png")));
		...
		mntmE.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/1416396371_companies.png")));
		...
		mnReportes.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/Bar Chart.png")));
		mnReportes.setFont(new Font("Tahoma", Font.BOLD, 12));

		JMenu mnSatisfechos = new JMenu("Satisfechos");
		mnSatisfechos.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/cheking.png")));
		...
		mnImprimir.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/1416396773_print.png")));
		mnImprimir.setFont(new Font("Tahoma", Font.BOLD, 12));

		JMenu mnConsultas = new JMenu("CONSULTAS");
		mnConsultas.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/Search.png")));
		mnConsultas.setFont(new Font("Tahoma", Font.BOLD, 12));
		menuBar.add(mnConsultas);

		JMenu mnAyuda = new JMenu("AYUDA");
		menuBar.add(mnAyuda);
		mnAyuda.setIcon(new ImageIcon(Welcome.class
				.getResource("/InterfazGrafica/1416396005_FAQ.png")));
		mnAyuda.setFont(new Font("Tahoma", Font.BOLD, 12));

		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1
				.setIcon(new ImageIcon(
						"C:\\Users\\Sorismelda\\Desktop\\7mo. Semestre\\Programacion 1\\Proyecto Final\\images (1).jpg"));
