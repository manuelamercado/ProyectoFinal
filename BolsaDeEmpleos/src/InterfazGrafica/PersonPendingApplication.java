...
Count.setText(String.valueOf(Satisfied.getInstanceSatisfied().getPendingPersonApplication().getPersonApplicantions().size()));
}
private void loadPerson() {
// TODO Auto-generated method stub
fila = new Object[5];
for (int i = 0, j=1; i <Satisfied.getInstanceSatisfied().getPendingPersonApplication().getPersonApplicantions().size(); i++,j++)
{
fila[0] = i+1;
fila[1] = Satisfied.getInstanceSatisfied().getPendingPersonApplication().getPersonApplication(i).getPerson().getID();
fila[2] = Satisfied.getInstanceSatisfied().getPendingPersonApplication().getPersonApplication(i).getPerson().getName();
fila[3] = Satisfied.getInstanceSatisfied().getPendingPersonApplication().getPersonApplication(i).getPerson().getLastName();
fila[4] = Satisfied.getInstanceSatisfied().getPendingPersonApplication().getPersonApplication(i).getArea();
