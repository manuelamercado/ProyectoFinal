...
private CollectionCompanyApplication Pendinng;
...
{
fila[0] = i+1;
fila[1] = Satisfied.getInstanceSatisfied().getPendingCompanyApplication().getCompanyApplication(i).getCompany().getRNC();
