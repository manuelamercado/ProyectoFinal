...
public class CompanyRegister extends JDialog {
	...
	public CompanyRegister() {
		...
		comboBoxArea.setModel(new DefaultComboBoxModel(CompanyType.values()));
		...
		JLabel lblActividad = new JLabel("Actividad:");
		 ...
		 final JComboBox comboBoxSector = new JComboBox();
		 ...
		 JLabel lblTipoDeEmpresa = new JLabel("Sector:");
		 lblTipoDeEmpresa.setHorizontalAlignment(SwingConstants.RIGHT);
		 lblTipoDeEmpresa.setBounds(10, 120, 100, 14);
		 CompanyDates.add(lblTipoDeEmpresa);
		...
		textFieldEmail.setBounds(116, 25, 212, 20);
		...
		textFieldWeb = new JTextField();
		 textFieldWeb.setBounds(116, 149, 212, 20);
		 ...
		 lblPginaWeb.setBounds(10, 155, 100, 14);
		...
		try {
			mascara1 = new MaskFormatter("###-###-####");
			 ...
			 formattedTextFieldFax.setBounds(116, 56, 212, 20);
		...
		try {
			...
			formattedTextFieldPhone = new JFormattedTextField(mascara2);
			 formattedTextFieldPhone.setBounds(116, 87, 212, 20);
		...
		try {
			...
			formattedTextFieldPostal = new JFormattedTextField(mascara3);
			 formattedTextFieldPostal.setBounds(116, 118, 212, 20);
		...
		label_13.setBounds(451, 202, 19, 20);
		...
		try {
		 ...
		 formattedTextFieldRNC = new JFormattedTextField();
		 formattedTextFieldRNC.setBounds(513, 200, 140, 20);
			 ...
			 buttonPane.add(btnReiniciar);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						temp.setSector(textFieldSector.getText());
